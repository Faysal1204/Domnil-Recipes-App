...
export const SparklesIcon = ({ className }: IconProps) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.293 2.293a1 1 0 010 1.414L10 17l-4 4 4-4 6.293 6.293a1 1 0 01-1.414 1.414L5 15.707a1 1 0 010-1.414L10.293 9 5 3.707a1 1 0 011.414 0L10 8.293l4.293-4.293a1 1 0 011.414 0L17 5.293l2.293-2.293a1 1 0 011.414 0L21 4.293l-1.707 1.707a1 1 0 01-1.414 0L15.586 3.707 10 9.293 4.707 4 3.293 5.414 8.586 10.707l-2.293 2.293a1 1 0 01-1.414-1.414L6 10.293 3.707 8 2.293 9.414 6 13.121l-1.293 1.293a1 1 0 01-1.414 0L1 12.121l1.293-1.293a1 1 0 011.414 0L6 13.121l-1.707 1.707a1 1 0 01-1.414-1.414L5 11.293 3.293 13 2.293 12 5 9.293l-1.707-1.707a1 1 0 010-1.414L5 3z" />
  </svg>
);
